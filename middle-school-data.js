const MIDDLE_SCHOOL_RAW_STANDARDS = {};

MIDDLE_SCHOOL_RAW_STANDARDS['중등국어'] = `[9국01-01] 화자의 의도와 관점을 추론하며 듣는다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등수학'] = `[9수01-01] 소인수분해의 뜻을 알고, 자연수를 소인수분해 할 수 있다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등영어'] = `[9영01-01] 단어, 어구, 문장을 듣고 연음이나 축약된 소리를 식별한다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등도덕'] = `[9도01-01] 자신의 삶과 가치관에 대한 성찰을 통해 자아를 올바로 이해하고, 삶에서 도덕이 필요한 이유에 근거하여 도덕적인 삶에 대한 의지를 기른다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등정보'] = `[9정01-01] 컴퓨팅 시스템의 구성요소와 동작 원리를 이해하고, 운영 체제의 기능을 분석한다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등한문'] = `[9한01-01] 한자의 모양⋅음⋅뜻을 구별한다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등사회'] = `[9사(지리)01-01] 세계 여러 지역의 특성을 해당 지역의 위치와 자연⋅인문환경을 고려하여 추론한다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등역사'] = `[9역01-01] 역사와 역사 탐구의 의미를 파악하고, 역사 학습의 목적을 다각도로 탐색한다.
...
MIDDLE_SCHOOL_RAW_STANDARDS['중등과학'] = `[9과01-01] 과학적 탐구 방법을 이해하고, 일상생활의 문제에 대한 과학적 해결 방안을 제안할 수 있다.
...
const MIDDLE_SCHOOL_SUBJECT_PROFILES = {
  math: [{ value: '중등수학', label: '중등수학' }],
  korean: [{ value: '중등국어', label: '중등국어' }],
  english: [{ value: '중등영어', label: '중등영어' }],
  social: [
    { value: '중등사회', label: '중등사회' },
    { value: '중등역사', label: '중등역사' }
  ],
  ethics: [{ value: '중등도덕', label: '중등도덕' }],
  science: [{ value: '중등과학', label: '중등과학' }],
  information: [{ value: '중등정보', label: '중등정보' }],
  classicalChinese: [{ value: '중등한문', label: '중등한문' }]
};

const MIDDLE_SCHOOL_NEW_SUBJECT_PROFILES = {
  classicalChinese: {
    label: '한문',
    courses: MIDDLE_SCHOOL_SUBJECT_PROFILES.classicalChinese
  }
};
